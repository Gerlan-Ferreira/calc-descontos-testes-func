...
public class Locators {
    ...
    public static final String VALUE_IDADE_MENOR_QUE_18_FORM_CONTACT = "Menor que 18 anos";

    public static final String VALUE_IDADE_MAIOR_IGUAL_A_18_E_MENOR_QUE_30_FORM_CONTACT = "Entre 18 e 29 anos";

    public static final String VALUE_IDADE_MAIOR_IGUAL_A_30_E_MENOR_QUE_65_FORM_CONTACT = "Entre 30 e 64 anos";

    public static final String VALUE_IDADE_MAIOR_IGUAL_A_65_FORM_CONTACT = "A partir de 65 anos";
    ...
    public static final String XPATH_MESSAGE_ERROR_FORM_CONTACT = "//div[@class='alert alert-dismissable alert-error']//span[.='Sua mensagem não pôde ser enviada no momento! Tente mais tarde.']";
